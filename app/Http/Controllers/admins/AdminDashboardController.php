...
class AdminDashboardController extends Controller
{
    public function AdminDashboardPage()
    {
        ...
        if ($activeSchoolYear) {
            ...
            $usersQuery = User::whereNotIn('role', ['superadmin', 'admin'])->where(function ($q) use ($activeSchoolYear) {
            ...
            $recentUsers = User::whereNotIn('role', ['superadmin', 'admin'])->latest()->take(6)->get();
            $educationLevels = EducationLevel::withCount(['gradeLevels', 'subjects'])->get();
        }
