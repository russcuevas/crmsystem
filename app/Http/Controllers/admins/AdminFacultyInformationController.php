...
class AdminFacultyInformationController extends Controller
{
    public function AdminFacultyInformationPage()
    {
        ...
        return view('admins.faculty_information.index', compact(
            'teachers',
            'activeSchoolYear',
            'totalAccounts',
            'totalFaculty',
