...
{
    public function SuperAdminSchoolYearPage()
    {
        ...
        return view('superadmins.school_years.index', compact(
            'schoolYears',
            'activeSchoolYear',
            'totalAccounts',
            'totalFaculty',
    ...
    public function store(Request $request)
    {
        ...
        // If no active school year exists in database, force this new one to be active
    ...
    public function setActive($id)
    {
        ...
        // Set session active school year
