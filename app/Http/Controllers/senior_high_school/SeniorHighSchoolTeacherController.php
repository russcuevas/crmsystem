...
class SeniorHighSchoolTeacherController extends Controller
{
    public function SeniorHighSchoolDashboardPage()
    {
        ...
        $assignedSubjectsQuery = ClassSectionSubject::with(['classSection.gradeLevel', 'classSection.course', 'subject', 'classSection.schoolYear'])
        ...
        return view('senior_high_school.dashboard.index', compact(
            'user',
            'teacher',
            'activeSchoolYear',
            'advisorySections',
