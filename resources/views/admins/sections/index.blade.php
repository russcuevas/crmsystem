                ...
                @php
                    ...
                    if (!$isJhsOrBedFilter && isset($sections) && $sections->isNotEmpty()) {
                        $isJhsOrBedFilter = $sections->every(function ($sec) {
                            $code = strtoupper($sec->gradeLevel->educationLevel->code ?? '');
            ...
            <form action="{{ route('admin.sections.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>Target School Year <span style="color: #ef4444;">*</span></label>
                        <select name="school_year_id" class="form-control-custom" required>
                    ...
                    <div class="form-group">
                        ...
                        @if ($autoSectionLevelObj)
                            <input type="hidden" name="education_level_id" id="add_section_education_level_hidden"
                                value="{{ $autoSectionLevelObj->id }}"
                                data-code="{{ strtoupper($autoSectionLevelObj->code) }}">
                            <input type="text"
                                value="{{ $autoSectionLevelObj->name }} ({{ $autoSectionLevelObj->code }})"
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.75rem;">
                        ...
                        <div class="form-group" id="add_section_course_wrapper">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="section_name" class="form-control-custom"
                            placeholder="e.g. Grade 7 - Einstein or BSIT 1-A" required>
                    </div>

                    <div class="form-group" id="add_section_adviser_wrapper">
            ...
            <form id="editSectionForm" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="school_year_id" id="edit_section_school_year" class="form-control-custom" required>
                            @foreach ($schoolYears as $sy)
                    ...
                    <div class="form-group">
                        <label>Education Level <span style="color: #ef4444;">*</span></label>
                        <select name="education_level_id" id="edit_section_education_level" class="form-control-custom"
                            required onchange="handleSectionLevelCascade('edit')">
                            <option value="">-- Select Level --</option>
                            @foreach ($educationLevelsList as $lvl)
                                <option value="{{ $lvl->id }}" data-code="{{ strtoupper($lvl->code) }}">
                                    {{ $lvl->name }} ({{ $lvl->code }})
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.75rem;">
                        ...
                        <div class="form-group" id="edit_section_course_wrapper">
                            <label>Course / Strand</label>
                    ...
                    <div class="form-group" id="edit_section_adviser_wrapper">
...
@push('scripts')
    ...
    <script>
        function handleSectionLevelCascade(prefix, targetGradeLevelId = null, targetCourseId = null, targetAdviserId =
            ...
            const hiddenEl = document.getElementById(`${prefix}_section_education_level_hidden`);
            const selectEl = document.getElementById(`${prefix}_section_education_level`);
            ...
            const gradeSelect = document.getElementById(`${prefix}_section_grade_level`);
            const courseSelect = document.getElementById(`${prefix}_section_course`);
            const courseWrapper = document.getElementById(`${prefix}_section_course_wrapper`);
            const advSelect = document.getElementById(`${prefix}_section_adviser`);
            const advGroup = document.getElementById(`${prefix}_section_adviser_wrapper`);

            // 1. Grade Level Filtering
            if (gradeSelect) {
            ...
            // 3. Adviser Filtering & College Exception
            if (levelCode === 'COLLEGE') {
        ...
        $(document).ready(function() {
            if ($('#sectionsTable').length) {
                $('#sectionsTable').DataTable({
                    ...
                    "language": {
                        "search": "",
                        "searchPlaceholder": "Search section name, grade level...",
        ...
        function openEditSectionModal(section) {
            ...
            form.action = "{{ url('/admin/sections/update') }}/" + section.id;
