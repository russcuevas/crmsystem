...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div style="display: flex; gap: 0.75rem; align-items: center;">
                <button class="btn-primary" onclick="openAddEnrollmentModal()">+ Enroll Student to Section</button>
            </div>
        </div>

        <div class="card-body">
            <div class="table-responsive">
                <table class="custom-table" id="enrollmentTable">
                    <thead>
                        <tr>
        ...
        <div class="modal-card">
            ...
            <form action="{{ route('admin.enrollment.store') }}" method="POST">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn-cancel" onclick="closeAddEnrollmentModal()">Cancel</button>
    ...
    <div class="modal-overlay" id="editEnrollmentModal">
        <div class="modal-card">
            <div class="modal-header">
                <h3 style="font-size: 1.1rem; font-weight: 800; margin: 0;">Edit Enrollment Record</h3>
            ...
            <form id="editEnrollmentForm" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.75rem;">
                        <div class="form-group">
                            ...
                            <select name="status" id="edit_enrollment_status" class="form-control-custom">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn-cancel" onclick="closeEditEnrollmentModal()">Cancel</button>
        ...
        $(document).ready(function() {
            if ($('#enrollmentTable').length) {
                $('#enrollmentTable').DataTable({
                    ...
                    "language": {
                        "search": "",
                        "searchPlaceholder": "Search student, LRN, section...",
