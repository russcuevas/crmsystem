                    ...
                    <tbody>
                        @forelse ($sections as $section)
                            <tr>
                                ...
                                <td>{{ $section->adviser ? $section->adviser->first_name . ' ' . $section->adviser->last_name : 'Unassigned' }}
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="4" style="text-align: center; color: var(--text-muted);">No class sections
                                    found.</td>
                            </tr>
                        @endforelse
                    </tbody>
