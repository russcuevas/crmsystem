                ...
                <tbody>
                    @forelse ($teachers as $teacher)
                        <tr>
                            ...
                            <td><span class="badge badge-teacher">{{ $teacher->educationLevel->code ?? 'N/A' }}</span></td>
                            <td>{{ $teacher->phone_number }}</td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="5" style="text-align: center; color: var(--text-muted);">No faculty members found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
