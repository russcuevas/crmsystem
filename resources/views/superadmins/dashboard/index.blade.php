    ...
    <div class="dashboard-content-grid">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('superadmin.accounts.page', array_filter(['level' => $selectedLevel])) }}"
        ...
        <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                        ...
                        @foreach ($educationLevels as $lvl)
                            ...
                            <div class="level-card"
                                ...
                                <div style="margin-top: 10px; display: flex; gap: 6px;">
                                    <a href="{{ route('superadmin.students.page', ['level' => $lvl->code]) }}"
                                        class="level-action-btn" title="View {{ $lvl->code }} Students">
                                        Students
                                    </a>
                                    <a href="{{ route('superadmin.faculty.page', ['level' => $lvl->code]) }}"
                                        class="level-action-btn" title="View {{ $lvl->code }} Faculty">
                                        Faculty
                                    </a>
                                    <a href="{{ route('superadmin.sections.page', ['level' => $lvl->code]) }}"
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('superadmin.faculty.page', array_filter(['level' => $selectedLevel])) }}"
                        class="btn-action">View All</a>
                </div>
