...
@section('content')
    <!-- Banner Card -->
    <div
        style="background: linear-gradient(135deg, #1e1b4b 0%, #312e81 60%, #4338ca 100%); border-radius: 1rem; padding: 2rem 2.5rem; color: #ffffff; margin-bottom: 2rem; box-shadow: var(--shadow-lg); position: relative; overflow: hidden; display: flex; justify-content: space-between; align-items: center;">
        <div style="position: relative; z-index: 2;">
            <span
                style="display: inline-block; background: #f59e0b; color: #1e1b4b; padding: 0.35rem 0.85rem; border-radius: 0.375rem; font-weight: 800; font-size: 0.775rem; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 0.75rem;">
                Junior High School Level (Grade 7 - 10)
            </span>
            <h2 style="font-size: 1.75rem; font-weight: 800; margin-bottom: 0.5rem;">
                Welcome, {{ $teacher->first_name }} {{ $teacher->last_name }}!
            </h2>
            <p style="color: #c7d2fe; font-size: 0.95rem;">
                Manage your handled class sections, subject records, student enrollments, and grades for Junior High School.
            </p>
        </div>
    </div>
    ...
    <div
        ...
        <div
            ...
            <div
                style="width: 52px; height: 52px; border-radius: 0.75rem; background: #e0e7ff; color: #3730a3; display: flex; align-items: center; justify-content: center; font-size: 1.4rem;">
        ...
        <div
            ...
            <div>
                ...
                <div style="font-size: 1.25rem; font-weight: 800; color: #0f172a; margin-top: 0.15rem;">JHS Level</div>
            </div>
        </div>
    </div>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(420px, 1fr)); gap: 1.75rem;">
        ...
        <div
            ...
            <div
                ...
                <h3
                    ...
                    <i class="fa-solid fa-users-rectangle" style="color: #4f46e5;"></i> My Advisory Class Sections
                </h3>
                <span
                    style="background: #e0e7ff; color: #3730a3; padding: 0.25rem 0.65rem; border-radius: 0.375rem; font-size: 0.75rem; font-weight: 700;">
        ...
        <div
            ...
            <div
                ...
                <h3
                    style="font-size: 1.05rem; font-weight: 700; color: #0f172a; display: flex; align-items: center; gap: 0.6rem;">
                    <i class="fa-solid fa-book-bookmark" style="color: #4f46e5;"></i> My Assigned Teaching Subjects
                </h3>
                <span
                    style="background: #e0e7ff; color: #3730a3; padding: 0.25rem 0.65rem; border-radius: 0.375rem; font-size: 0.75rem; font-weight: 700;">
